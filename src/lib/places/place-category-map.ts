...
const CATEGORY_TO_PLACE_TYPES: Record<EventCategory, string[]> = {
  ...
  GASTRONOMY: ['restaurant', 'cafe', 'bakery'],
  SPORTS: ['gym', 'stadium'],
  ART: ['art_gallery', 'museum'],
  FILM_THEATER: ['movie_theater', 'performing_arts_theater'],
  OUTDOORS: ['park', 'hiking_area', 'national_park'],
  ...
  PETS: ['dog_park', 'pet_store'],
  // Sem equivalente social bom no Places (New): encontros desses temas não
  // acontecem num "estabelecimento" pesquisável. Ficam órfãs de propósito — o
  // service barra com 400 quando TODAS as preferências caem aqui.
  TECH: [],
  BUSINESS: [],
  VOLUNTEERING: [],
  OTHER: [],
